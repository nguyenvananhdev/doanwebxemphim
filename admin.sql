...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th4 14, 2023 lúc 03:34 PM
...
(16, '0223111deb9137cf6e80-removebg-preview (2).png', 'ưeqweq', '22', '2023-04-15', 4, 'abđ', 'eqwewqewqweq', 'qưeewq');
...
INSERT INTO `users` (`id`, `first_name`, `last_name`, `user_name`, `email`, `password`, `gender`, `dob`, `role`) VALUES
(1, 'Assignment', 'Assignment', 'admin', 'test@test.com', '1234', 'male', '1997-05-06', 1),
(2, 'claire', 'C', 'Claire', 'clair@gmail.com', '123', 'female', '2000-03-11', 0);
