...
<div class="breadcrumb">
                    ...
                    <div href="<?php echo $trangchu ?>/phim/<?php echo $row['link']?>" title="<?php echo $row['tenphim']?>" class="item">
                        <span ><?php echo $row['tenphim']?></span>
                    </div>
                     <div class="item">
                        <span >Tập <?php echo $taphientai ?></span>
                    </div>
                </div>
           <div id="media">
...
?>
                        <div>
                                                            <div><div id="VoHuuNhan"><iframe style="border: 0;width: 100%;height: 100%;max-height: 300px;" src="<?php
...
?>"></iframe></div></div>                                                                        </div>
                        <div class="controls" itemscope="" itemtype="http://data-vocabulary.org/Review-aggregate">
                            <a target="_blank" href="<?php echo $trangchu ?>/download/<?php echo $url_phim ?>"><div class="download"><i></i><span>Download</span></div></a>
...
echo 'Google Drive';}
if (strpos($LoaiPhim, 'animehay.tv') !== false) {
echo 'Animehay';}
if (strpos($LoaiPhim, 'fembed.com') !== false) {
echo 'Fembed';}
?>)</label>
                <ul class="episodes">
...
?>
					...
					echo 'active';
					} ?>" id="ep_<?php echo "".$row["tap"].""; ?>" title="Xem Tập <?php echo $row['tap']?>" href="<?php echo $trangchu ?>/xem/<?php echo $row['link']?>/<?php echo $row['tap']?>" data-id="<?php echo "".$row["tap"].""; ?>"><?php echo $row['tap']?></a>
                    </li>	<?php
				}}
			?>
                ...
                <div class="widget info">
                    ...
                    <div class="widget-body">
                        <div class="content" data-name="content">
                            <div data-numposts="5" data-order-by="reverse_time" colorscheme="dark" data-colorscheme="dark" data-width="100%" width="100%" class="fb-comments" data-href="<?php echo $trangchu ?>/Info/<?php echo $url_phim ?>" data-numposts="50"></div>
                        </div>
                    </div>    <?php }} ?>
                ...
                <div id="fb-root"></div>
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v3.2&appId=<?php echo $appid ?>&autoLogAppEvents=1"></script>
           <?php
           $sql = "SELECT * FROM tap WHERE tap = '$taphientai' AND link = '$url_phim'";
$result = $conn->query($sql);
if ($result->num_rows > 0) 
